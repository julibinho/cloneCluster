...
#############################################################
def execution_time(path_to_file):
    liste = path_to_file
...
<<<<<<< HEAD
    ...
    with open(os.environ["RESULT_INTER"], "r+") as fichier_bad: #os.environ["RESULT_INTER"] permet de récupérer la variable d'environnement RESUL_INTER qu'on a exportée depuis le bash dans os.
        cmpt=0
