...
pwd = os.getcwd()
sys.path.append(pwd+'/algoCluster/Input_Output')
...
if REAL :
	...
	chemin_CDR3 = {'mono' : pwd+'/data/Real/Extracted_CDR3/P3_CDR3_mono.fa', 
		       ...
		       'IMGT_poly' : pwd+'/data/Real/Extracted_CDR3/Extracted_by_IMGT/I4_poly_CDR3_NA.txt'}
	...
	result_CDR3 = {'mono' : pwd+'/result/Real/Extracted_CDR3/P3_CDR3_mono.txt', 
		       ...
		       'IMGT_poly' : pwd+'/result/Real/Extracted_CDR3/IMGT_I4_poly.txt'}
